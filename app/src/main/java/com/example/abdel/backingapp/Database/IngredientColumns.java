...
public interface IngredientColumns {
    ...
    @DataType(DataType.Type.TEXT)  String INGREDIENT_NAME = "name";

    @DataType(DataType.Type.INTEGER) String QUANTITY = "quantity";

    @DataType(DataType.Type.INTEGER) String MEASURE = "measure";
